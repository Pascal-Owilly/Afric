          ...
          <Container fluid style={{ backgroundColor:'purple', height:'100%'}}> 
            <Row >
              <Col md={4} className='text-center'>
                <h5 className='text-center' style={{ color: '#999999', fontWeight:'200px', fontFamily:'verdana' }}>Site Links</h5>
                <ul>
                <li className='mt-2' style={{listStyleType:'none'}}>
                    <Link style={{textDecoration:'none', color: '#fff', cursor: 'pointer'}} to='/'> Home </Link>
                  </li>
                  <li className='mt-2' style={{listStyleType:'none'}}>
                    <Link style={{textDecoration:'none', color: '#fff', cursor: 'pointer'}} to='/about'> About, Mission, Vision </Link>
                  </li>
                  <li className='mt-2' style={{listStyleType:'none'}}>
