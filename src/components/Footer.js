  ...
  return (
    <footer className="" style={{backgroundColor:'purple', color:'white'}}>
      <Container fluid>
        <Row>
          <Col md={4}>
            ...
            <ul className="list-unstyled text-white text-muted">
              <li><Link className="list-unstyled text-white text-muted" style={{textDecoration:'none', fontStyle:'italic'}} to="/home">Home</Link></li>
              <li><Link className="list-unstyled text-white text-muted" style={{textDecoration:'none', fontStyle:'italic'}} to="/about">About Us</Link></li>
              <li><Link className="list-unstyled text-white text-muted" style={{textDecoration:'none', fontStyle:'italic'}} to="/contact">Contact</Link></li>
              <li><Link className="list-unstyled text-white text-muted" style={{textDecoration:'none', fontStyle:'italic'}} to="/team">Team</Link></li>
              <li><Link className="list-unstyled text-white text-muted" style={{textDecoration:'none', fontStyle:'italic'}} to="/socialent">Social Enterprise</Link></li>
            </ul>
          </Col>
          <Col md={4}>
            <h5>Disclaimer</h5>
       ...
       style={{width:"100%", height:"100", border:'3px solid #cceeee'}}  
        ...
        <Row  style={{backgroundColor:'goldenrod'}}>
          ...
          <p style={{ color: 'black', fontWeight:'bold', textAlign:'center' }}>Mwani Africa &copy; 2023</p> 
            ...
            <Col md={2} classnName="mr-5" style={{width:''}}>
            <FooterCard
              name="Pascal Owilly"
