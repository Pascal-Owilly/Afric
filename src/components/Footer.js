        ...
        <Container fluid style={{ backgroundColor:'purple', height:'100%'}}> 
          <Row >
            <Col md={8} className='mt-0'>   
              ...
              <h4 className="text-white"  style={{ color: '#ffffff', fontWeight:'200px', fontFamily:'verdana' }}> Disclaimer: </h4>
            <p className='text-white text-muted'>  The information on this website is for general informational purposes only and should not be considered as professional advice.
